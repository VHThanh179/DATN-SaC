#pragma checksum "C:\Users\Navteiv\Desktop\DATN\DATN-SaC\Client\Shared\WebLayout.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f42e6e84e95d013dae7aaee56b69f13df0582dab"
// <auto-generated/>
        ...
        <nav id=""navbar"" class=""navbar order-last order-lg-0""><ul><li><a class=""nav-link active"" style=""cursor:pointer"" onclick=""document.getElementById('hero').scrollIntoView({behavior:'smooth'})"">Trang chủ</a></li>
                ...
                <li class=""dropdown""><a style=""cursor:pointer""><span>Tài khoản</span> <i class=""bi bi-chevron-down""></i></a>
                    <ul><li><a class=""nav-link scrollto"" href=""/login"">Đăng nhập</a></li>
                        <li><a class=""nav-link scrollto"" href=""#"">Đăng ký</a></li></ul></li></ul>
            <i class=""bi bi-list mobile-nav-toggle""></i></nav></div></header>
